...
public class Device_Configuration extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback, NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connection_device.connectToDevice(bledisp, Device_Configuration.this);
        ...
        disconnect_ble.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Device_Configuration.this, "Disconnesso dal Dispositivo", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        ...
        manual.setOnClickListener(sendcommand);
        ...
        myDB = new MyDatabaseHelper(Device_Configuration.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.nav_device:
                startActivity(new Intent(Device_Configuration.this, Device_Fragment.class));
                break;
            case R.id.info_person:
                Toast.makeText(this, "Info", Toast.LENGTH_SHORT).show();
                break;
            case R.id.ble_configured:
                startActivity(new Intent(Device_Configuration.this, Configured_Devices.class));
                break;
            case R.id.nav_home:
    ...
    LinearLayout.OnClickListener bleaddtodb = new ImageView.OnClickListener(){
        public void onClick(View v){
            ...
            MyDatabaseHelper myDB = new MyDatabaseHelper(Device_Configuration.this);
    ...
    View.OnClickListener sendcommand = new View.OnClickListener(){
        public void onClick(View v){
            ...
            if(v.getId() == R.id.manual) connection_device.sendCommand("?");
            if(v.getId() == R.id.battery) connection_device.sendCommand("b");
            if(v.getId() == R.id.temperature) connection_device.sendCommand("t");
            if(v.getId() == R.id.buzzer1) connection_device.sendCommand("z");
            if(v.getId() == R.id.buzzer2) connection_device.sendCommand("Z");
            try {
